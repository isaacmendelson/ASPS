...
export const TELEGRAM_SYSTEM_PROMPT_APPEND = [
  ...
  "Routine read-only git plumbing (e.g. status/log/diff/branch/remote get-url) runs immediately without a prompt; any git write (commit/push/checkout/merge/rebase/reset, and similar) still requires Telegram approval like any other state-changing action.",
