...
def send_device_alert_with_response(port=50001, host="localhost"):
...
if __name__ == "__main__":
    ...
    print("\nChoose mode:")
    print("1. REQ/REP mode (waits for response)")
    print("2. PUSH/PULL mode (fire-and-forget, no response)")
    print()
    ...
    if mode == "2":
        ...
        print("\n[1/2] Sending RemoteAccessAlert...")
        send_device_alert_with_response()
